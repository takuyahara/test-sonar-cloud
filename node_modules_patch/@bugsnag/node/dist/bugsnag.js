...
var __isoDate_2 = _$esUtils_7.isoDate;
...
var _$config_4 = {};
var __filter_4 = _$esUtils_7.filter,
    __reduce_4 = _$esUtils_7.reduce,
    __keys_4 = _$esUtils_7.keys,
...
var __reduce_20 = _$esUtils_7.reduce,
    __filter_20 = _$esUtils_7.filter;
...
function () {
  function BugsnagReport(errorClass, errorMessage, stacktrace, handledState) {
    ...
    this.stacktrace = __reduce_20(stacktrace, function (accum, frame) {
...
BugsnagReport.getStacktrace = function (error, errorFramesToSkip, generatedFramesToSkip) {
  ...
  if (_$hasStack_8(error)) return ErrorStackParser.parse(error).slice(errorFramesToSkip); // error wasn't provided or didn't have a stacktrace so try to walk the callstack

  return __filter_20(StackGenerator.backtrace(), function (frame) {
...
var _$BugsnagReport_20 = BugsnagReport;
...
var os = require("os"),
    padding = 2,
    pid = _$pad_18(process.pid.toString(36), padding),
    hostname = os.hostname(),
    length = hostname.length,
    hostId = _$pad_18(hostname.split('').reduce(function (prev, char) {
...
var __isoDate_21 = _$esUtils_7.isoDate;
...
/* removed: var _$BugsnagReport_20 = require('./report'); */;

/* removed: var _$BugsnagBreadcrumb_2 = require('./breadcrumb'); */;

/* removed: var _$Session_21 = require('./session'); */;

var __map_3 = _$esUtils_7.map,
    __includes_3 = _$esUtils_7.includes,
    __isArray_3 = _$esUtils_7.isArray;
...
function () {
  function BugsnagClient(notifier) {
    ...
    this.BugsnagReport = _$BugsnagReport_20;
    this.BugsnagBreadcrumb = _$BugsnagBreadcrumb_2;
    this.BugsnagSession = _$Session_21;
    var self = this;
  ...
  _proto.notify = function notify(error, opts, cb) {
    ...
    var report = _$BugsnagReport_20.ensureReport(err, errorFramesToSkip, 1);
    ...
    _$asyncSome_5(beforeSend, _$runBeforeSend_14(report, onBeforeSendErr), function (err, preventSend) {
...
var ___require_23 = require("url"),
    parse = ___require_23.parse;

var _$request_23 = function (_ref, cb) {
  var url = _ref.url,
...
/* removed: var _$request_23 = require('./request'); */;

var _$delivery_22 = function () {
  return {
      ...
      try {
        _$request_23({
          ...
          headers: {
            ...
            'Bugsnag-Sent-At': __isoDate_22()
          },
          body: _$jsonPayload_10.report(report, config.filters),
          agent: config.agent
        }, function (err, body) {
          return _cb(err);
        });
    ...
    sendSession: function (logger, config, session, cb) {
      ...
      try {
        _$request_23({
          ...
          body: _$jsonPayload_10.session(session, config.filters),
          agent: config.agent
        }, function (err) {
          return _cb(err);
        });
...
var __reduce_24 = _$esUtils_7.reduce;

var __stringWithLength_24 = _$validators_15.stringWithLength;

var __os_24 = require("os");
...
var _$config_24 = {
  projectRoot: {
    ...
    validate: function (value) {
      return value === null || __stringWithLength_24(value);
    },
    message: 'should be string'
  },
  hostname: {
    defaultValue: function () {
      return __os_24.hostname();
    },
    message: 'should be a string',
    validate: function (value) {
      return value === null || __stringWithLength_24(value);
  ...
  logger: ___extends_24({}, schema.logger, {
    defaultValue: function () {
      return getPrefixedConsole();
    }
  }),
  releaseStage: ___extends_24({}, schema.releaseStage, {
    defaultValue: function () {
...
var getPrefixedConsole = function () {
  return __reduce_24(['debug', 'info', 'warn', 'error'], function (accum, method) {
...
_$nodeFallbackStack_11.getStack = function () {
...
_$nodeFallbackStack_11.maybeUseFallbackStack = function (err, fallbackStack) {
...
var _$reportFromError_13 = function (maybeError, handledState) {
  var actualError = iserror(maybeError) ? maybeError : new Error('Handled a non-error. See "error" tab for more detail.');
  var report = new _$BugsnagReport_20(actualError.name, actualError.message, _$BugsnagReport_20.getStacktrace(actualError), handledState);
...
/* removed: var _$reportFromError_13 = require('@bugsnag/core/lib/report-from-error'); */;

var getStack = _$nodeFallbackStack_11.getStack,
    maybeUseFallbackStack = _$nodeFallbackStack_11.maybeUseFallbackStack;

var _$contextualize_26 = {
  name: 'contextualize',
  init: function (client) {
    var contextualize = function (fn, opts) {
      ...
      dom.on('error', function (err) {
        ...
        var report = _$reportFromError_13(err, {
          severity: 'error',
          unhandled: true,
          severityReason: {
...
var __getStack_27 = _$nodeFallbackStack_11.getStack,
    __maybeUseFallbackStack_27 = _$nodeFallbackStack_11.maybeUseFallbackStack;
...
var _$intercept_27 = {
  ...
  init: function (client) {
    var intercept = function (opts, cb) {
      ...
      var fallbackStack = __getStack_27();
      return function (err) {
        if (err) {
          // check if the stacktrace has no context, if so, if so append the frames we created earlier
          if (err.stack) __maybeUseFallbackStack_27(err, fallbackStack);
          var report = _$reportFromError_13(err, {
            severity: 'warning',
            unhandled: false,
            severityReason: {
...
var __isoDate_28 = _$esUtils_7.isoDate;
/*
...
var ___require_12 = require("path"),
    join = ___require_12.join,
    resolve = ___require_12.resolve; // normalise a path to a directory, adding a trailing slash if it doesn't already
// have one and resolve it to make it absolute (e.g. get rid of any ".."s)


var _$pathNormalizer_12 = function (p) {
  return join(resolve(p), '/');
};

var __map_29 = _$esUtils_7.map;

/* removed: var _$pathNormalizer_12 = require('@bugsnag/core/lib/path-normalizer'); */;

var _$inProject_29 = {
  init: function (client) {
    return client.config.beforeSend.push(function (report) {
      if (!client.config.projectRoot) return;
      var projectRoot = _$pathNormalizer_12(client.config.projectRoot);
      report.stacktrace = __map_29(report.stacktrace, function (stackframe) {
...
var ___require_30 = require("fs"),
    createReadStream = ___require_30.createReadStream;

var ___require2_30 = require("stream"),
    Writable = ___require2_30.Writable;

var pump = require("pump");

var byline = require("byline");

var _$surroundingCode_30 = {
  init: function (client) {
...
function (_Writable) {
  ...
  function CodeRange(opts) {
    ...
    _this = _Writable.call(this, ___extends_30({}, opts, {
      decodeStrings: false
    })) || this;
...
var _$uncaughtException_31 = {
  init: function (client) {
    if (!client.config.autoNotify) return;

    _handler = function (err) {
      client.notify(_$reportFromError_13(err, {
        severity: 'error',
        unhandled: true,
        severityReason: {
          type: 'unhandledException'
...
var _$unhandledRejection_32 = {
  init: function (client) {
    if (!client.config.autoNotify) return;

    ___handler_32 = function (err) {
      client.notify(_$reportFromError_13(err, {
        severity: 'error',
        unhandled: true,
        severityReason: {
    ...
    process.on('unhandledRejection', ___handler_32);
  },
  destroy: function () {
    process.removeListener('unhandledRejection', ___handler_32);
  }
};
...
function ___inheritsLoose_35(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
/*#__PURE__*/
function (_Emitter) {
  ___inheritsLoose_35(SessionTracker, _Emitter);
...
function ___extends_34() { ___extends_34 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ___extends_34.apply(this, arguments); }

var __isArray_34 = _$esUtils_7.isArray,
    __includes_34 = _$esUtils_7.includes;

/* removed: var _$inferReleaseStage_9 = require('@bugsnag/core/lib/infer-release-stage'); */;

var __intRange_34 = _$validators_15.intRange;

/* removed: var _$cloneClient_6 = require('@bugsnag/core/lib/clone-client'); */;

/* removed: var _$tracker_35 = require('./tracker'); */;

/* removed: var _$Backoff_33 = require('backo'); */;

var _$session_34 = {
  init: function (client) {
    var sessionTracker = new _$tracker_35(client.config.sessionSummaryInterval);
  ...
  configSchema: {
    sessionSummaryInterval: {
      ...
      validate: function (value) {
        return value === undefined || __intRange_34()(value);
      },
...
var sendSessionSummary = function (client) {
  return function (sessionCounts) {
    var releaseStage = _$inferReleaseStage_9(client); // exit early if the reports should not be sent on the current releaseStage

    if (__isArray_34(client.config.notifyReleaseStages) && !__includes_34(client.config.notifyReleaseStages, releaseStage)) {
...
var _$stripProjectRoot_36 = {
  init: function (client) {
    return client.config.beforeSend.push(function (report) {
      if (!client.config.projectRoot) return;
      var projectRoot = _$pathNormalizer_12(client.config.projectRoot);
      report.stacktrace = __map_36(report.stacktrace, function (stackframe) {
...
var _$notifier_25 = {};
function ___extends_25() { ___extends_25 = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return ___extends_25.apply(this, arguments); }

var name = 'Bugsnag Node';
var version = '6.0.0-alpha.1';
var url = 'https://github.com/bugsnag/bugsnag-js';

/* removed: var _$BugsnagClient_3 = require('@bugsnag/core/client'); */;

/* removed: var _$delivery_22 = require('@bugsnag/delivery-node'); */; // extend the base config schema with some node-specific options


var __schema_25 = ___extends_25({}, _$config_4.schema, _$config_24); // remove autoBreadcrumbs from the config schema


delete __schema_25.autoBreadcrumbs;

/* removed: var _$surroundingCode_30 = require('@bugsnag/plugin-node-surrounding-code'); */;

/* removed: var _$inProject_29 = require('@bugsnag/plugin-node-in-project'); */;

/* removed: var _$stripProjectRoot_36 = require('@bugsnag/plugin-strip-project-root'); */;

/* removed: var _$session_34 = require('@bugsnag/plugin-server-session'); */;

/* removed: var _$device_28 = require('@bugsnag/plugin-node-device'); */;

/* removed: var _$uncaughtException_31 = require('@bugsnag/plugin-node-uncaught-exception'); */;

/* removed: var _$unhandledRejection_32 = require('@bugsnag/plugin-node-unhandled-rejection'); */;

/* removed: var _$intercept_27 = require('@bugsnag/plugin-intercept'); */;

/* removed: var _$contextualize_26 = require('@bugsnag/plugin-contextualize'); */;

var plugins = [_$surroundingCode_30, _$inProject_29, _$stripProjectRoot_36, _$session_34, _$device_28, _$uncaughtException_31, _$unhandledRejection_32, _$intercept_27, _$contextualize_26];

_$notifier_25 = function (opts, userPlugins) {
  ...
  bugsnag.delivery(_$delivery_22());
  bugsnag.setOptions(opts);
  bugsnag.configure(__schema_25);
...
_$notifier_25['default'] = _$notifier_25;

return _$notifier_25;
