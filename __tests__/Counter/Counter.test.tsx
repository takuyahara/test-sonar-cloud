    ...
    describe('MouseEvent', () => {
      ...
      describe('Timer is not started', () => {
        it('Ring.mousedown', () => {
          ...
          expect(counterInstance.getStatus()).toBe(Status.Stopped);
        });
        ...
        it('Ring.mousedown => Ring.mouseup => Indicator.click', () => {
          ...
          expect(counterInstance.getStatus()).toBe(Status.Running);
        });
        ...
        it('Indicator.click 2 times', () => {
          ...
          expect(counterInstance.getStatus()).toBe(Status.Paused);
        });
