...
import { default as Beat, StatusBeat, StatusIncrement } from 'AxlMetronome/Counter/Beat/BeatAxl';
    ...
    describe('Tempo increases', () => {
      ...
      describe('Mouseevent', () => {
        it('click 1 time / Running', () => {
          ...
          expect(beatInstance.getStatusBeat()).toBe(StatusBeat.Running);
          expect(beatInstance.getStatusIncrement()).toBe(StatusIncrement.Running);
        ...
        it('click 2 times / Paused', () => {
          ...
          expect(beatInstance.getStatusBeat()).toBe(StatusBeat.Paused);
          expect(beatInstance.getStatusIncrement()).toBe(StatusIncrement.Paused);
        ...
        it('click and finish', () => {
          ...
          expect(beatInstance.getStatusBeat()).toBe(StatusBeat.Stopped);
          expect(beatInstance.getStatusIncrement()).toBe(StatusIncrement.Stopped);
    ...
    describe(`Tempo doesn't change`, () => {
      ...
      describe('Mouseevent', () => {
        it('click 1 time / Running', () => {
          ...
          expect(beatInstance.getStatusBeat()).toBe(StatusBeat.Running);
          expect(beatInstance.getStatusIncrement()).toBe(StatusIncrement.NeverIncrement);
          expect(spy.onAccelerate.callCount).toBe(0);
          expect(spy.onTick.callCount).toBe(4);
          expect(spy.onStart.callCount).toBe(1);
          expect(spy.onStop.callCount).toBe(0);
        ...
        it('click and finish', () => {
          ...
          expect(beatInstance.getStatusIncrement()).toBe(StatusIncrement.NeverIncrement);
          expect(spy.onAccelerate.callCount).toBe(0);
          expect(spy.onTick.callCount).toBe(46);
          expect(spy.onStart.callCount).toBe(1);
          expect(spy.onStop.callCount).toBe(1);
          expect(spy.onPause.callCount).toBe(0);
          expect(spy.onResume.callCount).toBe(0);
