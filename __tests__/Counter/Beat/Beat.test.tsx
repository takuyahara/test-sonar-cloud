...
import Status from 'AxlMetronome/Counter/Beat/Status';
  ...
  describe('without post process', () => {
    ...
    describe('Mouseevent', () => {
      ...
      it('click 1 time', () => {
        ...
        clock.tick(30000);
        expect(beatInstance.getStatus()).toBe(Status.Running);
      ...
      it('click 2 times', () => {
        ...
        beat.find(sel('beat-taparea')).simulate('click');
        clock.tick(30000);
        expect(beatInstance.getStatus()).toBe(Status.Paused);
        expect(spy.toggle.callCount).toBe(1);
      ...
      it('click 1 time and stop (intend to be called from parent)', () => {
        beat.find(sel('beat-taparea')).simulate('click');
        beatInstance.stop();
        expect(beatInstance.getStatus()).toBe(Status.Stopped);
        expect(spy.toggle.callCount).toBe(1);
