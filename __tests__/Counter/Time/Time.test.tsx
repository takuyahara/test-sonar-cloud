...
import Timer from 'AxlMetronome/Counter/Time/Timer';
...
import State from 'AxlMetronome/Counter/Time/Status';
    ...
    describe('MouseEvent', () => {
      describe('Time is not running', () => {
        it('Indicator.click 1 time', () => {
          ...
          expect(timeInstance.getStatus()).toBe(State.Running);
        ...
        it('Indicator.click 2 times', () => {
          ...
          clock.tick(2000);
          expect(timeInstance.getProgress()).toBe(0.2);
          expect(timeInstance.getStatus()).toBe(State.Paused);
        ...
        it('Indicator.click and complete counting down', () => {
          ...
          expect(timeInstance.getProgress()).toBe(0);
          expect(timeInstance.getStatus()).toBe(State.Stopped);
